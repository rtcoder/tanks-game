...
const canvasWallsMinimap = document.getElementById('canvas-walls-minimap');
const ctx = canvas.getContext('2d');
const ctxMinimap = canvasMinimap.getContext('2d');
const ctxWalls = canvasWalls.getContext('2d');
const ctxWallsMinimap = canvasWallsMinimap.getContext('2d');
const maxGameWidth = 3000;
const maxGameHeight = 2200;
const minimapWidth = 800;
const minimapHeight = minimapWidth * (maxGameHeight / maxGameWidth);
const canvasShift = {
  x: 0,
  y: 0
};
