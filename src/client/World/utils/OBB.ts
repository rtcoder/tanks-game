import {Box3, MathUtils, Matrix3, Matrix4, Plane, Ray, Sphere, Vector3} from 'three';

// module scope helper variables

const a: { c: Vector3 | null, u: Vector3[], e: number[] } = {
  c: null, // center
  u: [new Vector3(), new Vector3(), new Vector3()], // basis vectors
  e: [], // half width
};

const b: { c: Vector3 | null, u: Vector3[], e: number[] } = {
  c: null, // center
  u: [new Vector3(), new Vector3(), new Vector3()], // basis vectors
  e: [], // half width
};
...
class OBB {
   ...
   *
   */
  intersectsOBB(obb: OBB, epsilon = Number.EPSILON) : boolean {
